  ...
  return (
    <div className="carousel w-full">
      <div id="slide1" className="carousel-item relative w-full">
        ...
        />
        <div>
          <h1 className="absolute flex justify-center items-end left-5 right-5 bottom-0 text-6xl font-black text-center text-white tracking-widest p-5 uppercase shadow-2xl">
            WELCOME TO WEST
            <GiEagleEmblem />
      ...
      <div id="slide2" className="carousel-item relative w-full">
        <img
          src="https://images.unsplash.com/photo-1662096909687-7c64cde3524b?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1374&q=80"
