  ...
  return (
    <section className="carousel w-full mb-10">
      <div id="slide1" className="carousel-item relative w-full ">
        ...
        />
        <div>
          <h1 className="absolute invisible md:visible flex justify-center items-end left-5 right-5 bottom-0 text-xl font-black text-center text-white tracking-widest p-5 uppercase shadow-2xl">
            WELCOME TO WEST
            <GiEagleEmblem />
      ...
      <div id="slide2" className="carousel-item relative w-full ">
        ...
        />
        <div className="">
          <h1 className=" invisible md:visible absolute flex justify-center items-end left-5 right-5 bottom-0 text-xl font-black text-center text-white tracking-widest p-5 uppercase shadow-2xl">
            WELCOME TO WEST
            <GiEagleEmblem />
            <span className="text-info"> EAGLE</span>
          </h1>
      ...
      <div id="slide3" className="carousel-item relative w-full ">
        ...
        />
        <div>
          <h1 className="invisible md:visible absolute flex justify-center items-end left-5 right-5 bottom-0 text-xlfont-black text-center text-white tracking-widest p-5 uppercase shadow-2xl">
            WELCOME TO WEST
            <GiEagleEmblem />
            <span className="text-info"> EAGLE</span>
          </h1>
